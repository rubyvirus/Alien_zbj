...
public class AutoTestListener extends TestListenerAdapter {
    ...
    public void onFinish(ITestContext testContext) {
        ...
        // List of testx results which we will delete later
        ArrayList<ITestResult> testsToBeRemoved = new ArrayList<ITestResult>();
        // collect all id's from passed testx
        ...
        for (ITestResult failedTest : testContext.getFailedTests()
            ...
            // if we saw this testx as a failed testx before we mark as to be
            // deleted
            // or delete this failed testx if there is at least one passed
            // version
